...
Full live-JSON inventory (AF coverage, medical, language stack, RCSB, fly walking, honesty walls) is `python scripts/system_verify.py` → **245** checks, `docs/SYSTEM_VERIFY.md`. Layer B does not replace that inventory.
