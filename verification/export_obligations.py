...
def collect() -> tuple[list[Obl], dict[str, Any]]:
    ...
    obl: list[Obl] = [
        ...
        Obl("plant_rice_maize_folded", "FSOT.Genetics.Plant.RiceMaize", "B", "nat_eq",
            "plant_rice_maize_folded", plant_h_n, 12, "rice+maize 12/12 measured homolog folds", "data/plant_homolog.json"),
        Obl("plant_rice_maize_miss", "FSOT.Genetics.Plant.RiceMaize", "B", "nat_eq",
            "plant_rice_maize_miss", plant_h_miss, 0, "rice+maize true 1:1 miss = 0", "data/plant_homolog.json"),
        Obl("plant_min_id_close", "FSOT.Genetics.Plant.RiceMaize", "B", "nat_le",
            "plant_min_id", close_milli, milli(plant_h_min),
            "rice/maize min template identity ≥ 1/φ", "data/plant_homolog.json"),
