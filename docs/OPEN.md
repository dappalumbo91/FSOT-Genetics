...
| Organism 3-D / lineage | Proxy find **1.00**, follow **0.96 / 0.98**, Jaccard **0.96**. Dense find **0.96**, follow **0.84 / 0.97**, Jaccard **0.78 (adj. 0.79)** — TP 1478 / FP 12 / FN 393. Product graph = primary + isolated residual; unmatched dest fill at φ⁴ µm (1-1 steal leftover). Kaggle U-Net leftover notebook public **0.821** (not Final; 0.848 holds). |
