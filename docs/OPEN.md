...
| Organism 3-D / lineage | Proxy 7 µm **1.00**, lineage **0.82 / 0.90**. Dense 1950 GT: 7 µm **0.96**, lineage **0.69 / 0.78**. Leftover ER: ~22% of dense GEFF edges (mostly residual-only cells + Hungarian steal). |
