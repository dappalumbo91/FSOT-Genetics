...
| Organism 3-D / lineage | Proxy find **1.00**, follow **0.94 / 0.98**, native Jaccard **0.86 (adj. 0.80)**. Dense find **0.96**, follow **0.85 / 0.97**, native Jaccard **0.67 (adj. 0.65)**. Live Kaggle top **0.962**; our public U-Net floor **0.848**. Local U-Net climb: leftover φ⁴ **0.689→0.711** (baseline) / **0.743→0.760** (v3). Native leftover is FN + node-count tax, not steal. |
