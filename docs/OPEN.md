...
| Organism 3-D / lineage | Proxy find **1.00**, follow **0.94 / 0.98**, Jaccard **0.94**. Dense find **0.96**, follow **0.84 / 0.97**, Jaccard **0.77 (adj. 0.78)** — TP 1450 / FP 11 / FN 421. Product graph = primary + isolated residual (halo residual stole GT matches). Leftover ~22% dense FN at 7 µm. Kaggle is the reference metric, not a second stack. |
