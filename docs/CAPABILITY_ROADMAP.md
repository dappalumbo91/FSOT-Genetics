...
**Organism 3-D (Biohub / Zebrahub):** residual second collapse + primary Hungarian + φ⁵ leftover links. Proxy 7 µm **1.00** / lineage **0.90**. Dense 1950-GT: 7 µm **0.96**, lineage **0.78**. AF does not score this. `docs/BIOHUB_3D.md`.
