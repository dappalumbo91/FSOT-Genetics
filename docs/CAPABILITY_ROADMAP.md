...
**Organism 3-D (Biohub / Zebrahub):** native observer finds dense cells at 7 µm **0.96**. Product graph Jaccard **0.81 (adj. 0.82)**; proxy **0.98**. Kaggle U-Net leftover public **0.821** is not Final (0.848 holds). `docs/BIOHUB_3D.md`.
