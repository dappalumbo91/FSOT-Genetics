...
**Organism 3-D:** Biohub tracking is **back burner** (`docs/BIOHUB_FREEZE.md`). FlyWire / BANC / Male CNS / larva / worm both sexes are live hops (`docs/SPECIES_CONNECTOMES.md`, `docs/RESULTS.md`). Protein product freeze unchanged (0.13 Å). Plants: product Cα only (`scripts/plant_product.py`).
