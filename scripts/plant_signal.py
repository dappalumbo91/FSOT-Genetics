...
CLASSES: dict[str, dict[str, str]] = {
    ...
    "P14712": {"symbol": "PHYA", "class": "photoreceptor", "job": "far-red phytochrome"},
    ...
    "O49686": {"symbol": "PYR1", "class": "aba_receptor", "job": "ABA receptor PYR/PYL"},
    "O80920": {"symbol": "PYL4", "class": "aba_receptor", "job": "ABA receptor PYR/PYL"},
    "P49597": {"symbol": "ABI1", "class": "aba_phosphatase", "job": "PP2C ABA negative"},
    "O04719": {"symbol": "ABI2", "class": "aba_phosphatase", "job": "PP2C ABA negative"},
    # stomatal effectors
    "Q9LD83": {"symbol": "SLAC1", "class": "stomata_channel", "job": "guard-cell anion channel"},
    "Q39128": {"symbol": "KAT1", "class": "stomata_channel", "job": "guard-cell K+ inward"},
    "Q94A76": {"symbol": "GORK", "class": "stomata_channel", "job": "guard-cell K+ outward"},
    # auxin / growth
    ...
    "O80536": {"symbol": "PIF3", "class": "light_tf", "job": "phytochrome interacting factor"},
