...
UniProt `P01116` · n=189 · Pfam `UniRef50_P01116` · MSA rows=78 · mean cons=0.96

Indication: oncogene / MAPK

Mean driver percentile: **38.62433862433863** · LIKELY DAMAGING 6/6

| HGVS | cons | impact% | call | note |
|------|-----:|--------:|------|------|
| p.G12D | 1.00 | 39 | LIKELY DAMAGING | codon 12 classic |
| p.G12V | 1.00 | 39 | LIKELY DAMAGING | codon 12 classic |
| p.G12C | 1.00 | 39 | LIKELY DAMAGING | codon 12 (sotorasib) |
| p.G13D | 1.00 | 39 | LIKELY DAMAGING | codon 13 |
| p.Q61H | 1.00 | 39 | LIKELY DAMAGING | switch II |
| p.Q61L | 1.00 | 39 | LIKELY DAMAGING | switch II |

## SOD1 — Superoxide dismutase [Cu-Zn]

UniProt `P00441` · n=154 · Pfam `UniRef50_P00441` · MSA rows=48 · mean cons=0.81

Indication: ALS

Mean driver percentile: **69.11312371838689** · LIKELY DAMAGING 4/4

| HGVS | cons | impact% | call | note |
|------|-----:|--------:|------|------|
| p.A5V | 0.96 | 63 | LIKELY DAMAGING | A4V historic / aggressive ALS |
| p.G94A | 1.00 | 73 | LIKELY DAMAGING | G93A historic mouse model |
